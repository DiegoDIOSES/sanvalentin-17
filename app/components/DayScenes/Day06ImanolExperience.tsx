        ...
        >
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              <motion.div
                key="step2"
                className="absolute inset-0 px-5 md:px-8 pt-28 md:pt-32 pb-8"
                  ...
                  <div className="mt-6">
                    <Day06ConstellationCinematic
                      onComplete={() => {
                        if (!completed) {
                          setCompleted(true);
                          onWin(); // victoria al completar acto 2
                        }
            ...
            {step === 3 && (
              <motion.div
                key="step3"
                className="absolute inset-0 px-5 md:px-8 pt-28 md:pt-32 pb-10 flex items-start justify-center"
                initial={{ opacity: 0, y: 16 }}
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                transition={{ duration: 0.55 }}
                ...
                <div className="w-full max-w-3xl">
                  ...
                  <div className="mt-6">
                    <Day06CleanReveal
                      ...
                      onReveal={() => {
                        // aquí puedes subir a 2 victorias si quieres.
                        // onWin();
                      }}
                    />
                  </div>
